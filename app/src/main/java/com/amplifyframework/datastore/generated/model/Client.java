...
@ModelConfig(pluralName = "Clients", authRules = {
...
public final class Client implements Model {
  ...
  public static final QueryField NAME = field("Client", "name");
  public static final QueryField DESCRIPTION = field("Client", "description");
  public static final QueryField ADDED_AT = field("Client", "addedAt");
  public static final QueryField TELEPHONE = field("Client", "telephone");
  ...
  private Client(String id, String name, String description, String addedAt, String telephone) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), client.getId()) &&
              ObjectsCompat.equals(getName(), client.getName()) &&
              ObjectsCompat.equals(getDescription(), client.getDescription()) &&
              ObjectsCompat.equals(getAddedAt(), client.getAddedAt()) &&
              ObjectsCompat.equals(getTelephone(), client.getTelephone()) &&
